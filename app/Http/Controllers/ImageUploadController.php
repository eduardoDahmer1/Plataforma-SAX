...
class ImageUploadController extends Controller
{
    public function index()
    {
        ...
        return view('admin.admin', compact('webpImage', 'logoPalace', 'logoBridal', 'logoCafeBistro', 'logoCafeBistroAsuncion', 'noimage', 'banners', 'bannerLinks', 'attribute', 'homeBannerGroups'));
    }
    ...
    // --- Métodos Logo Bridal ---
    public function uploadLogoBridal(Request $request)
    {
        return $this->uploadImage($request, 'logo_bridal', 'logo_bridal.webp');
    }

    public function deleteLogoBridal()
    {
        return $this->deleteImage('logo_bridal');
    }

    // --- Métodos Logo Café & Bistrô ---
    public function uploadLogoCafeBistro(Request $request)
    {
        return $this->uploadImage($request, 'logo_cafe_bistro', 'logo_cafe_bistro.webp');
    }

    public function deleteLogoCafeBistro()
    {
        return $this->deleteImage('logo_cafe_bistro');
    }

    // --- Logo exclusiva Café & Bistrô Asunción ---
    public function uploadLogoCafeBistroAsuncion(Request $request)
    {
        return $this->uploadImage($request, 'logo_cafe_bistro_asuncion', 'logo_cafe_bistro_asuncion.webp');
    }

    public function deleteLogoCafeBistroAsuncion()
    {
        return $this->deleteImage('logo_cafe_bistro_asuncion');
    }

    // --- MÉTODOS PARA OS NOVOS ÍCONES ---
    public function uploadIconInfo(Request $request)
    {
        return $this->uploadImage($request, 'icon_info', 'icon_info.webp');
    }

    public function deleteIconInfo()
    {
        return $this->deleteImage('icon_info');
    }

    public function uploadIconCabide(Request $request)
    {
        return $this->uploadImage($request, 'icon_cabide', 'icon_cabide.webp');
    }

    public function deleteIconCabide()
    {
        return $this->deleteImage('icon_cabide');
    }

    public function uploadIconHelp(Request $request)
    {
        return $this->uploadImage($request, 'icon_help', 'icon_help.webp');
    }

    public function deleteIconHelp()
    {
        return $this->deleteImage('icon_help');
    }

    // --- Outros Métodos ---
    public function uploadNoimage(Request $request)
    {
        return $this->uploadImage($request, 'noimage', 'noimage.webp');
    }

    public function deleteNoimage()
    {
        return $this->deleteImage('noimage');
    }

    // Banners legados da home
    public function uploadBanner1(Request $request)
    {
        return $this->uploadImage($request, 'banner1', 'banner1.webp');
    }

    public function deleteBanner1()
    {
        return $this->deleteImage('banner1');
    }

    public function uploadBanner2(Request $request)
    {
        return $this->uploadImage($request, 'banner2', 'banner2.webp');
    }

    public function deleteBanner2()
    {
        return $this->deleteImage('banner2');
    }

    public function uploadBanner3(Request $request)
    {
        return $this->uploadImage($request, 'banner3', 'banner3.webp');
    }

    public function deleteBanner3()
    {
        return $this->deleteImage('banner3');
    }

    public function uploadBanner4(Request $request)
    {
        return $this->uploadImage($request, 'banner4', 'banner4.webp');
    }

    public function deleteBanner4()
    {
        return $this->deleteImage('banner4');
    }

    public function uploadBanner5(Request $request)
    {
        return $this->uploadImage($request, 'banner5', 'banner5.webp');
    }

    public function deleteBanner5()
    {
        return $this->deleteImage('banner5');
    }

    public function uploadBanner6(Request $request)
    {
        return $this->uploadImage($request, 'banner6', 'banner6.webp');
    }

    public function deleteBanner6()
    {
        return $this->deleteImage('banner6');
    }

    public function uploadBanner7(Request $request)
    {
        return $this->uploadImage($request, 'banner7', 'banner7.webp');
    }

    public function deleteBanner7()
    {
        return $this->deleteImage('banner7');
    }

    public function uploadBanner8(Request $request)
    {
        return $this->uploadImage($request, 'banner8', 'banner8.webp');
    }

    public function deleteBanner8()
    {
        return $this->deleteImage('banner8');
    }

    public function uploadBanner9(Request $request)
    {
        return $this->uploadImage($request, 'banner9', 'banner9.webp');
    }

    public function deleteBanner9()
    {
        return $this->deleteImage('banner9');
    }

    public function uploadWhatsappBanner(Request $request)
    {
        return $this->uploadImage($request, 'whatsapp_banner', 'whatsapp_banner.webp');
    }

    public function deleteWhatsappBanner()
    {
        return $this->deleteImage('whatsapp_banner');
    }
}
