...
/**
 * Códigos internacionais de chamada por território ISO 3166-1.
 *
 * Fonte: metadados do Google libphonenumber. O GeoNames fornece países e
 * localidades, mas o endpoint gratuito countryInfoJSON não inclui DDI.
 */
final class CountryCallingCodes
{
    ...
    {
        return self::CODES[strtoupper(trim($iso2))] ?? '';
    }
}
