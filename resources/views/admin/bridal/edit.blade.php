                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="border rounded-3 p-3 h-100" style="background:#fafafa;">
                            ...
                            <div class="mb-2">
                                <label class="sax-form-label">{{ __('messages.button_text_label') }}</label>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="border rounded-3 p-3 h-100" style="background:#fafafa;">
                            ...
                            <div class="mb-2">
                                <label class="sax-form-label">{{ __('messages.author_name_label') }}</label>
                                <input type="text" name="testimonials_items[{{ $i }}][author]"
                                       class="form-control sax-input"
                                       value="{{ old("testimonials_items.$i.author", $testimonials[$i]['author'] ?? '') }}">
                            </div>
                            <div class="mb-2">
                                <label class="sax-form-label">{{ __('messages.location_label') }}</label>
                            ...
                            <div class="mb-0">
                                <label class="sax-form-label">{{ __('messages.testimonial_label') }}</label>
                                <textarea name="testimonials_items[{{ $i }}][quote]"
                                          ...
                                          placeholder="{{ __('messages.testimonial_text_placeholder') }}">{{ old("testimonials_items.$i.quote", $testimonials[$i]['quote'] ?? '') }}</textarea>
                        ...
                        <div class="col-md-4 location-item">
                            <div class="border rounded-3 p-3 bg-light position-relative">
                                ...
                                <input type="hidden" name="locations_items[{{ $i }}][image_path]"
                                       value="{{ $loc['image'] ?? '' }}">
                                <div class="mb-2">
                                    <label class="sax-form-label">{{ __('messages.name_label') }}</label>
                                    <input type="text" name="locations_items[{{ $i }}][name]"
                                           class="form-control sax-input"
                                           value="{{ old("locations_items.$i.name", $loc['name'] ?? '') }}">
                                </div>
                                <div class="mb-2">
                                    <label class="sax-form-label">{{ __('messages.address_label') }}</label>
