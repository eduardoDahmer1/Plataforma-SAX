...
<style>
    ...
    .text-bistro   { color: var(--bistro-primary) !important; }
    ...
    .sax-divider-bistro { width: 3.125rem; height: 0.25rem; background: var(--bistro-primary); margin: 0.625rem 0; border-radius: 0.125rem; }
    ...
    .sax-premium-card:hover {
        ...
        box-shadow: 0 0.625rem 1.875rem rgba(0,0,0,.08) !important;
    }
    ...
    .icon-circle-bistro {
        ...
        background: var(--bistro-light); color: var(--bistro-primary);
    ...
    .badge-section-done {
        background: #ecfdf5; color: var(--bistro-primary);
        padding: 0.25rem 0.75rem; border-radius: 1.25rem;
    ...
    .status-divider { width: 1px; height: 1.125rem; background: #e5e7eb; flex-shrink: 0; }
    .status-dot { width: 0.5625rem; height: 0.5625rem; border-radius: 50%; display: inline-block; flex-shrink: 0; }
    ...
    .section-pip { width: 0.5625rem; height: 0.5625rem; border-radius: 50%; }
    .pip-done    { background: #10b981; }
    .pip-empty   { background: #e5e7eb; }

    /* ── Edit Button ────────────────────────────────────── */
    .btn-dark-bistro {
        background: var(--sax-dark); color: #fff;
    ...
    /* ── Hero ───────────────────────────────────────────── */
    .hero-image-wrapper { height: 100%; min-height: 17.5rem; }

    /* ── Sobre ──────────────────────────────────────────── */
    .sobre-visual { width: 42%; min-height: 12.5rem; overflow: hidden; }

    /* ── Empty State ────────────────────────────────────── */
    .empty-state-mini { padding: 1.5rem 0.625rem; text-align: center; }
    .empty-icon { font-size: 1.8rem; color: #d1d5db; margin-bottom: 0.625rem; }

    /* ── Flash Alert ────────────────────────────────────── */
    .alert-modern     { border-radius: 0.75rem; border: none; }
    .alert-success.alert-modern { background: var(--sax-dark); color: var(--bistro-primary); }

    /* ── Responsive ─────────────────────────────────────── */
    @media (max-width: 768px) {
        .sobre-visual       { width: 100%; min-height: 9.375rem; }
        .hero-image-wrapper { min-height: 12.5rem; }
        .status-bar         { flex-direction: column; align-items: flex-start !important; gap: 0.625rem !important; }
