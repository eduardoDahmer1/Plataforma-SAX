<div class="sax-admin-sidebar">
    <nav class="sax-nav-container">
        ...
        <div class="nav-group">
            ...
            <div class="collapse sax-submenu" id="menuCatalogos">
                <a href="{{ route('admin.products.index') }}" class="submenu-link"><i class="fa-solid fa-box"></i>
                    Produtos</a>
                <a href="{{ route('admin.brands.index') }}" class="submenu-link"><i class="fa-solid fa-copyright"></i>
                    Marcas</a>
                <a href="{{ route('admin.categories.index') }}" class="submenu-link"><i class="fa-solid fa-tags"></i>
                    Categorias</a>
                <a href="{{ route('admin.subcategories.index') }}" class="submenu-link"><i class="fa-solid fa-tag"></i>
                    Subcategorias</a>
                <a href="{{ route('admin.categorias-filhas.index') }}" class="submenu-link"><i
        ...
        <div class="nav-group">
            ...
            <div class="collapse sax-submenu" id="menuVendas">
                <a href="{{ route('admin.orders.index') }}" class="submenu-link"><i class="fa-solid fa-receipt"></i>
                    Pedidos</a>
                <a href="{{ route('admin.clients.index') }}" class="submenu-link"><i class="fa-solid fa-user-tie"></i>
                    Clientes</a>
                <a href="{{ route('admin.payments.index') }}" class="submenu-link"><i
        ...
        <div class="nav-group">
            ...
            <div class="collapse sax-submenu" id="menuConteudos">
                <a href="{{ route('admin.blogs.index') }}" class="submenu-link"><i class="fa-solid fa-blog"></i>
                    Blog</a>
                <a href="{{ route('admin.contatos.index') }}" class="submenu-link"><i class="fa-solid fa-envelope"></i>
                    Contato</a>
        ...
        <div class="nav-group">
            ...
            <div class="collapse sax-submenu" id="menuSistema">
                <a href="{{ route('admin.sections_home.index') }}" class="submenu-link"><i
    ...
    <i class="fa-solid fa-broom"></i> Limpar Cache
                ...
                <a href="{{ route('admin.currencies.index') }}" class="submenu-link"><i class="fa-solid fa-coins"></i>
                    Moedas</a>
                <a href="{{ route('admin.palace.index') }}" class="submenu-link"><i class="fas fa-hotel"></i> Conteúdo
                    Palace</a>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (clearCacheBtn) {
        clearCacheBtn.addEventListener('click', function (e) {
            ...
            // Força a URL para HTTPS caso o Laravel ainda gere HTTP
