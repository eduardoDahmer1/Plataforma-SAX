    ...
    <div class="card h-100 shadow-sm border-0 position-relative">
        ...
        <div class="card-body d-flex flex-column">
            ...
            <p class="card-text small text-muted mb-2">
                ...
                <i class="fas fa-dollar-sign me-1"></i> {{ isset($item->price) ? currency_format($item->price) : 'Não informado' }}<br>
            ...
            <div class="mt-auto d-flex flex-column">
                ...
                @auth
                    ...
                    @endif
                @else
                    <a href="#" class="btn btn-sm btn-warning mt-2" data-bs-toggle="modal" data-bs-target="#loginModal">
