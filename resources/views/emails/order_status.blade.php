...
@section('content')
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td style="padding:0.5rem 0;border-bottom:1px solid #ddd9d4;">
                            <span style="font-size:0.6875rem;text-transform:uppercase;letter-spacing:0.15rem;color:#888888;">Pedido</span>
                        </td>
    ...
    <p style="margin:0 0 1.5rem 0;font-size:0.9375rem;color:#333333;">
        Você pode acompanhar o status detalhado clicando no botão abaixo:
    </p>
