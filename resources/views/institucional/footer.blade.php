...
.footer-brand-inst span {
    ...
    font-weight: 300;
    letter-spacing: 6px;
    color: #c5a059; /* Dourado SAX */
    margin-top: 5px;
}

.footer-desc-inst {
    font-size: 0.85rem;
    color: #666666; /* Cinza médio para leitura */
    line-height: 1.8;
    margin-bottom: 30px;
}
...
.footer-col-title {
    ...
    letter-spacing: 3px;
    font-weight: 700;
    color: #c5a059; /* Títulos em Dourado */
    margin-bottom: 30px;
}
...
@media (max-width: 991px) {
    .footer-inst { text-align: center; padding: 60px 0 30px; }
    .footer-social-inst { justify-content: center; margin-bottom: 40px; }
    .footer-stats-list { margin-bottom: 40px; }
}
</style>