<section class="arabe-premium-section palace-section" id="noite-arabe">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-5 order-2 order-lg-1 palace-reveal" data-aos="fade-up">
            ...
            <div class="col-lg-7 order-1 order-lg-2 palace-reveal" data-aos="fade-left">
