                ...
                <div id="galleryCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner rounded-3 shadow-sm">
                        ...
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                            <img src="{{ $img }}" class="d-block w-100 object-fit-contain" style="max-height: 400px;"
                                alt="Galeria {{ $index + 1 }}">
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="col-lg-6 p-4 d-flex flex-column justify-content-between">
                ...
                <div class="mt-4 d-flex gap-3 flex-wrap">
                    ...
                    <form action="{{ route('cart.add') }}" method="POST" class="d-inline">
                        @csrf
                        <input type="hidden" name="product_id" value="{{ $product->id }}">
                        <button type="submit" class="btn btn-success px-4" @if($currentQty>= $product->stock) disabled
                            @endif>
