            ...
            <form action="{{ route('search') }}" method="GET" id="filterForm">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <input type="number" name="min_price" class="form-control" placeholder="Mín" min="5" value="{{ request('min_price', 5) }}">
                        <input type="number" name="max_price" class="form-control" placeholder="Máx" max="1000" value="{{ request('max_price', 1000) }}">
                    </div>
                            ...
                            <div class="card h-100 shadow-sm border-0">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text small text-muted mb-2">
                                        ...
                                        {{ isset($item->price) ? 'US$ ' . number_format($item->price, 2, ',', '.') : 'Não informado' }}
                                    </p>
