                                ...
                                <div class="card-body">
                                    <form action="{{ route('orders.deposit.submit', $order->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="deposit_receipt" id="deposit_receipt" class="form-control" required>
                                        </div>
            ...
            @foreach ($order->items as $item)
                <div class="col-md-6 col-lg-4">
                    <div class="card shadow-sm h-100">
                        <div class="card-body">
                            <h6 class="card-title">{{ $item->product->external_name ?? ($item->product->name ?? 'Produto') }}</h6>
