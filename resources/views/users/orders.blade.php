...
<div class="sax-orders-wrapper">
    <div class="dashboard-header d-flex justify-content-between align-items-end mb-5">
        <div>
            <h2 class="sax-title">Histórico de pedidos</h2>
                ...
                <tbody>
                    @foreach ($orders as $order)
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('user.orders.show', $order->id) }}" class="btn-sax-black-sm">
                                    DETALHES
                                </a>
                            </td>
                        </tr>
        ...
        <div class="d-md-none">
            @foreach ($orders as $order)
                ...
                <div class="order-card-sax shadow-sm">
                    ...
                    <a href="{{ route('user.orders.show', $order->id) }}" class="btn-sax-black w-100 mt-2">
                        DETALHES
                    </a>
                </div>
            @endforeach
